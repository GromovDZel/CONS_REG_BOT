...
function generateRandomUserAgent() {
    ...
    const browser = Object.keys(browsers)[Math.floor(Math.random() * 3)];
...
function setupBrowser() {
    return __awaiter(this, arguments, void 0, function* (headless = false) {
        ...
        const browserType = browserChoice === 'chromium' ? playwright_1.chromium : playwright_1.firefox;
        ...
        const userDataDir = fs_1.default.mkdtempSync(path_1.default.join(os_1.default.tmpdir(), 'playwright-' + Date.now()));
        const launchOptions = {
            headless,
            proxy: proxyConfig,
        ...
        for (let attempt = 0; attempt < maxRetries; attempt++) {
            try {
                ...
                const context = yield browserType.launchPersistentContext(userDataDir, launchOptions);
